...
from keras.layers import Dense, Dropout, Flatten, Activation, Convolution2D, MaxPooling2D, BatchNormalization, AveragePooling2D
import os, glob
import numpy as np
import csv
import pandas as pd
...
model.fit(X, y, callbacks=[checkpoint], validation_split=0.20, nb_epoch=50, shuffle=True, batch_size=64, verbose=1)
